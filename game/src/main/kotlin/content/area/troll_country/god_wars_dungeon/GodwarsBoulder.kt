...
class GodwarsBoulder {
    ...
    @Option("Move", "godwars_boulder")
    suspend fun boulder(player: Player, target: GameObject) {
    ...
    @Option("Crawl-through", "godwars_little_hole")
    suspend fun hole(player: Player, target: GameObject) {
