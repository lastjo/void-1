...
class ArmadylPillar(private val objects: GameObjects) {

    @Option("Grapple", "armadyl_pillar", approach = true)
    suspend fun grapple(player: Player, target: GameObject) {
        player.steps.clear()
    ...
    @Option("Search", "godwars_armadyl_crate")
