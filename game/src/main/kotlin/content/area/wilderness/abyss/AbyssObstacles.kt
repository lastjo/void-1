...
class AbyssObstacles {
    ...
    @Option("Burn-down", "abyss_boil")
    suspend fun burn(player: Player, target: GameObject) {
    ...
    @Option("Distract", "abyss_eyes")
    suspend fun distract(player: Player, target: GameObject) {
    ...
    @Option("Squeeze-through", "abyss_gap")
    ...
    @Option("Go-through", "abyss_passage")
