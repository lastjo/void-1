...
class Leela {
    ...
    fun ChoiceBuilder<Dialogue>.key() {
    ...
    fun ChoiceBuilder<Dialogue>.guards() {
    ...
    suspend fun Dialogue.guard(unsure: Boolean) {
        choice {
    ...
    suspend fun Dialogue.lostKey(): Boolean {
