...
class CaptainRovin {
    ...
    fun PlayerChoice.palaceGuard(): Unit = option<Quiz>("I am one of the palace guards.") {
    ...
    fun PlayerChoice.whatAboutKing(): Unit = option<Quiz>("What about the King? Surely you'd let him up here.") {
    ...
    fun PlayerChoice.itsImportant(): Unit = option<Talk>(
    ...
    fun PlayerChoice.newRecruit(): Unit = option<Talk>("I'm a new recruit.") {
    ...
    fun PlayerChoice.plasticSurgery(): Unit = option<Talk>("I've had extensive plastic surgery.") {
    ...
    fun PlayerChoice.theresADemon(): Unit = option<Talk>(
    ...
    fun PlayerChoice.forgot(): Unit = option<Upset>("Erm I forgot.") {
        npc<Angry>("Well it can't be that important then.")
        player<Talk>("How do you know?")
        npc<Angry>("Just go away.")
    }

    fun PlayerChoice.aleDelivery(): Unit = option<Neutral>("The castle has just received its ale delivery.") {
    ...
    fun PlayerChoice.notReallyPowerful(): Unit = option<Talk>("Not really.") {
        npc<Happy>("Well, I'm sure the palace guards can deal with it, then. Thanks for the information.")
    }

    fun PlayerChoice.yesVeryPowerful(): Unit = option<Upset>("Yes, very.") {
    ...
    fun PlayerChoice.palaceGuardsAreRubbish(): Unit = option<Chuckle>("Yeah, the palace guards are rubbish!") {
        npc<Chuckle>("Yeah, they're--")
        npc<Angry>("Wait! How dare you insult the palace guards? Get out of my sight!")
    }

    fun PlayerChoice.illFightIt(): Unit = option<Talk>("It's not them who are going to fight the demon, it's me.") {
    ...
    fun PlayerChoice.arisSaidSo(): Unit = option<Talk>("Fortune-teller Aris said I was destined to kill the demon.") {
    ...
    fun PlayerChoice.demonWillDestroyCity(): Unit = option<Afraid>("Otherwise the demon will destroy the city!") {
    ...
    fun PlayerChoice.prysinSaidSo(): Unit = option<Talk>("Sir Prysin said you would give me the key.") {
    ...
    fun PlayerChoice.whyDidHeGiveKeyToYou(): Unit = option<Quiz>("Why did he give you one of the keys then?") {
