...
class GrandExchangeClerk {
    ...
    @Option("Talk-to", "grand_exchange_clerk*", approach = true)
    ...
    @Option("Exchange", "grand_exchange_clerk*", approach = true)
    suspend fun exchange(player: Player, target: NPC) {
        player.approachRange(2)
        player.open("grand_exchange")
    }

    @Option("History", "grand_exchange_clerk*", approach = true)
    suspend fun history(player: Player, target: NPC) {
        player.approachRange(2)
        player.open("exchange_history")
    }

    @Option("Sets", "grand_exchange_clerk*", approach = true)
    suspend fun sets(player: Player, target: NPC) {
        player.approachRange(2)
