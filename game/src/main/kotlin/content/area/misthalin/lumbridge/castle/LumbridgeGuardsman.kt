...
class LumbridgeGuardsman {
    ...
    fun PlayerChoice.tellMeGuardsmen(): Unit = option<Quiz>("Tell me about the Lumbridge Guardsmen.") {
    ...
    fun PlayerChoice.aroundHere(): Unit = option<Quiz>("What is there to do around here?") {
        when (random.nextInt(0, 2)) {
    ...
    fun PlayerChoice.tellMeLumbridge(): Unit = option<Quiz>("Tell me about Lumbridge.") {
        when (random.nextInt(0, 3)) {
    ...
    fun PlayerChoice.whatAreGuarding(): Unit = option<Quiz>("What exactly are you guarding?") {
        when (random.nextInt(0, 2)) {
