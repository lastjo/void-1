...
class MillieMiller {
    ...
    fun PlayerChoice.whoAreYou(): Unit = option<Quiz>("Who are you?") {
    ...
    fun PlayerChoice.whatIsThisPlace(): Unit = option<Quiz>("What is this place?") {
    ...
    fun PlayerChoice.millFlour(): Unit = option<Quiz>("How do I mill flour?") {
