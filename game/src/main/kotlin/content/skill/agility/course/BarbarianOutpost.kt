...
class BarbarianOutpost {
    ...
    @Option("Squeeze-through", "barbarian_outpost_entrance")
    suspend fun entrance(player: Player, target: GameObject) {
    ...
    @Option("Swing-on", "barbarian_outpost_rope_swing")
    ...
    @Option("Walk-across", "barbarian_outpost_log_balance")
    suspend fun logBalance(player: Player, target: GameObject) {
    ...
    @Option("Climb-over", "barbarian_outpost_obstacle_net")
    ...
    @Option("Walk-across", "barbarian_outpost_balancing_ledge")
    suspend fun walkLedge(player: Player, target: GameObject) {
    ...
    @Option("Climb-over", "barbarian_outpost_crumbling_wall")
