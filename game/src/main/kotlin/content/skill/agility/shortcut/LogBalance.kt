...
class LogBalance {
    ...
    @Option("Walk-across", "coal_truck_log_balance")
    suspend fun coalTruck(player: Player, target: GameObject) {
    ...
    @Option("Walk-across", "ardougne_log_balance_east", "ardougne_log_balance_west")
    suspend fun ardougne(player: Player, target: GameObject) {
