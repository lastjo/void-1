...
class Talismans(private val teleports: ObjectTeleports) {

    private val overworld = Rectangle(2048, 2496, 3903, 4159)

    @Inventory("Locate", "*_talisman")
    fun locate(player: Player, item: Item) {
