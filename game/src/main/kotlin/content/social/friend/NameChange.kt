...
class NameChange(private val players: Players) {

    @Command("rename", description = "rename your accounts display name (login stays the same)", rights = PlayerRights.MOD)
    suspend fun command(player: Player, content: String) = player.dialogue {
