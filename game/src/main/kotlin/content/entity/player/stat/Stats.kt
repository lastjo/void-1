...
class Stats {
    ...
    @Interface("View", id = "stats")
    fun view(player: Player, component: String) {
    ...
    @Interface("Open subsection", id = "skill_guide")
    suspend fun open(player: Player, id: String, component: String) {
