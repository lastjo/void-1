...
class CombatDebug(private val npcDefinitions: NPCDefinitions) {

    @Command("maxhit [npc-id] [spell-id]", description = "calculate your max hit against an npc", rights = PlayerRights.MOD)
