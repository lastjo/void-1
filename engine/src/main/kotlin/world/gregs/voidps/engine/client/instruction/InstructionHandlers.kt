...
class InstructionHandlers(
    ...
    val interactInterface = InterfaceOptionHandler(handler, interfaceDefinitions, publishers)
    ...
    private val interactObject = ObjectOptionHandler(objects, objectDefinitions, publishers)
